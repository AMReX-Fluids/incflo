...
incflo::apply_MAC_projection (AMREX_D_DECL(Vector<MultiFab*> const& u_mac,
                              ...
                              Vector<Array<MultiFab,AMREX_SPACEDIM>> const& inv_rho,
                              Real time)
{
    ...
    MacProjector macproj(mac_vec                        , MLMG::Location::FaceCentroid, // Location of mac_vec   
                         GetVecOfArrOfConstPtrs(inv_rho), MLMG::Location::FaceCentroid, // Location of beta   
                                                        , MLMG::Location::CellCenter  , // Location of solution variable phi
                         Geom(0,finest_level), lp_info);
#else
    MacProjector macproj(mac_vec,GetVecOfArrOfConstPtrs(inv_rho),Geom(0,finest_level), lp_info);
#endif
