    ...
    AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        if (flag(i,j,k).isConnected(-1,0,0)) {
            ...
            if (flag(i,j,k).isRegular() or flag(i-1,j,k).isRegular()) {
                ...
                Real fracy = amrex::Math::abs(fcx(i,j,k,0));
                Real fracz = amrex::Math::abs(fcx(i,j,k,1));
    ...
    AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        if (flag(i,j,k).isConnected(0,-1,0)) {
            ...
            if (flag(i,j,k).isRegular() or flag(i,j-1,k).isRegular()) {
                ...
                Real fracx = amrex::Math::abs(fcy(i,j,k,0));
                Real fracz = amrex::Math::abs(fcy(i,j,k,1));
    ...
    AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        if (flag(i,j,k).isConnected(0,0,-1)) {
            ...
            if (flag(i,j,k).isRegular() or flag(i,j,k-1).isRegular()) {
                ...
                Real fracx = amrex::Math::abs(fcz(i,j,k,0));
                Real fracy = amrex::Math::abs(fcz(i,j,k,1));
